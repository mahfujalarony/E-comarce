...
exports.register = async (req, res) => {
    try {
        ...
        let profilePicsFolder = storage.root.children.find(child => child.name === 'ProfilePics' && child.directory);
        ...
        const uploadedFile = await profilePicsFolder.upload(uploadOptions, fileStream).complete;
