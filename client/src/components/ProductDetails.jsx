...
const ProductDetails = () => {
  ...
  const SkeletonLoader = () => (
    <div className="flex flex-col lg:flex-row gap-6 animate-fadeIn">
      <div className="w-full lg:w-1/2 bg-white p-4 rounded-lg shadow-md">
        <div className="w-full h-64 sm:h-80 md:h-96 bg-gray-300 animate-pulse rounded-lg" />
      </div>
      <div className="w-full lg:w-1/2 bg-white p-4 sm:p-6 rounded-lg shadow-md">
        <div className="h-8 bg-gray-300 rounded mb-2 animate-pulse" />
        <div className="h-4 w-32 bg-gray-300 rounded mb-3 animate-pulse" />
        <div className="h-6 w-24 bg-gray-300 rounded mb-2 animate-pulse" />
  ...
  return (
    <div 
      className="container mx-auto px-4 bg-gray-100 min-h-screen pt-[calc(60px+1rem)] md:pt-6" 
    >
      <style>
        {`
          @keyframes fadeIn {
